...
Generated 2026-08-23T22:23:37 from git commit `c00671a0e592f5ef9a0628e1bf0f8f2405107e96` (DIRTY -- see provenance in summary.json).
...
|---|---|---|---|---|---|---|---|---|
| nominal_heatup | 0.7074 | 0.2510 | 3.5158 | 0.6675 | 50.00% | 7.6158e-07 | 0 (0.0%) | 0.0006 |
| disturbance_step60 | 0.7929 | 0.2861 | 3.9519 | 0.6730 | 45.62% | 7.6158e-07 | 0 (0.0%) | 0.0005 |
| stiff_exotherm_window (steps 77-107 of nominal_heatup) | 0.5654 | 0.4183 | 0.6551 | 0.6675 | 16.13% | 6.8381e-07 | 0 (0.0%) | 0.0026 |
...
- nominal_heatup: 160/160 steps (100.0%) were feasible (scaled) enough to compute an objective gap; verified SNN convergence rate 50.00% (raw self-reported `converged` rate 50.00%).
- disturbance_step60: 160/160 steps (100.0%) feasible; verified convergence rate 45.62%.
- stiff_exotherm_window: 31/31 steps (100.0%) feasible; verified convergence rate 16.13%; max constraint residual 6.8381e-07 -- consistent with the earlier finding that both solvers can struggle on the raw scaled arrays at the gelation peak.
