...
Generated 2026-08-11T01:55:56 from git commit `70b83cd9b5dd35b2caf967e936355102037f597b` (DIRTY -- see provenance in summary.json).
...
|---|---|---|---|---|---|---|---|---|
| nominal_heatup | 0.7140 | 0.2488 | 3.5687 | 0.6601 | 0.00% | 1.5540e+00 | 21 (13.1%) | 0.0001 |
| disturbance_step60 | 0.7909 | 0.2792 | 3.9535 | 0.6559 | 0.00% | 2.0687e+00 | 24 (15.0%) | 0.0001 |
| stiff_exotherm_window (steps 77-107 of nominal_heatup) | 0.5590 | 0.4136 | 0.6479 | 0.6601 | 0.00% | 1.5540e+00 | 9 (29.0%) | 0.0001 |
...
- nominal_heatup: 77/160 steps (48.1%) were feasible (scaled) enough to compute an objective gap; verified SNN convergence rate 0.00% (raw self-reported `converged` rate 0.00%).
- disturbance_step60: 94/160 steps (58.8%) feasible; verified convergence rate 0.00%.
- stiff_exotherm_window: 14/31 steps (45.2%) feasible; verified convergence rate 0.00%; max constraint residual 1.5540e+00 -- consistent with the earlier finding that both solvers can struggle on the raw scaled arrays at the gelation peak.
